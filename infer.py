...
if __name__ == '__main__':
    ...
    parser.add_argument('--tgt_audio', type=str, default='samples/EM1_ENG_0037_1.wav')
    ...
    tgt_audio = load_audio(args.tgt_audio, model.config.audio.sample_rate)
    ...
    if args.streaming:
        ...
        pre_audio = synthesize_utt_streaming(model, src_wav, tgt_audio)
    else:
        pre_audio = synthesize_utt(model, src_wav, tgt_audio)
